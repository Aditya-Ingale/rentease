          ...
          <div className="flex lg:flex-col gap-3 h-24 lg:h-96 overflow-x-auto lg:overflow-x-visible lg:overflow-y-auto hide-scrollbar">
            {property.imageUrls.map((url, index) => (
              <button
                ...
                className={`flex-shrink-0 w-28 h-20 lg:w-full lg:h-[118px] bg-white/5 rounded-xl overflow-hidden border-2 transition-all ${
                  activePhotoIdx === index ? 'border-brand-accent' : 'border-transparent hover:border-white/15'
                }`}
              >
                ...
                <form onSubmit={handleReviewSubmit} className="pt-4 border-t border-white/5 space-y-4">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 bg-surface-raised border border-white/5 px-4 py-2.5 rounded-xl text-xs outline-none focus:border-brand-primary text-text-primary"
                    />
                    <Button
                      type="submit"
                      variant="primary"
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col space-y-1">
                  ...
                  <select
                    ...
                    className="bg-surface-raised border border-white/5 px-3 py-2 rounded-xl text-xs outline-none focus:border-brand-primary mt-1"
                  >
        ...
        <form onSubmit={handleBookingSubmit} className="space-y-5 text-left pt-2">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className="bg-surface-raised text-text-primary outline-none focus:border-brand-primary"
              required
            />
          ...
          <div className="space-y-2.5">
            ...
            <select
              ...
              className="bg-surface-raised border border-white/5 px-3 py-2 rounded-xl text-xs outline-none focus:border-brand-primary w-full mt-1"
            >
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              rows={3}
              className="w-full bg-surface-raised text-text-primary border border-white/5 px-4 py-2.5 rounded-xl text-xs outline-none focus:border-brand-primary"
              required
            />
          </div>
