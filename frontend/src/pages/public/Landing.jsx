...
const mockCities = [
  { name: 'Hyderabad', image: 'https://images.unsplash.com/photo-1587922546307-776227941871?w=800' },
  { name: 'Mumbai', image: 'https://images.unsplash.com/photo-1522240974558-860822605f63?w=800' },
  { name: 'Bangalore', image: 'https://images.unsplash.com/photo-1596176530529-78163a4f7af2?w=800' },
  { name: 'Delhi', image: 'https://images.unsplash.com/photo-1587474260584-136574528ed5?w=800' },
  { name: 'Pune', image: 'https://images.unsplash.com/photo-1579758629938-03607cdbc344?w=800' },
  { name: 'Chennai', image: 'https://images.unsplash.com/photo-1582510003544-4d00b7f7415e?w=800' }
];
          ...
          <div className="flex-1 flex items-center px-4 py-2 border-b md:border-b-0 md:border-r border-white/5">
            ...
            <div className="text-left w-full">
              ...
              <select
                ...
                className="w-full bg-transparent text-text-primary text-sm font-semibold border-none outline-none focus:ring-0 mt-0.5 cursor-pointer"
              >
                {mockCities.map(c => <option key={c.name} value={c.name} className="bg-surface-overlay text-text-primary">{c.name}</option>)}
              </select>
            </div>
          </div>
          ...
          <div className="flex-[1.5] flex items-center px-4 py-2">
            ...
            <div className="text-left w-full">
              ...
              <input
                ...
                className="w-full bg-transparent text-text-primary placeholder:text-text-muted text-sm font-semibold border-none outline-none focus:ring-0 mt-0.5"
              />
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
          {mockCities.map((c) => (
            <Card
              ...
              className="group overflow-hidden rounded-2xl cursor-pointer p-0 relative h-64 border border-white/5 bg-transparent"
            >
              {/* City Image */}
              <img
                src={c.image}
                alt={c.name}
                className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500 brightness-[0.4] group-hover:brightness-[0.3]"
              />
              {/* Content Overlay */}
              <div className="absolute inset-0 p-4 flex flex-col justify-end text-left">
                ...
                <p className="text-[10px] text-brand-accent font-semibold tracking-wider uppercase mt-1">
                  {c.count} Listings
                </p>
              </div>
            </Card>
